...
class OpinionAnalyzer:
    ...
    def analyze_opinion_changes(self, conversation_history: List[Tuple], agents: List[SimpleAgent]) -> None:
        """
        ...
        for agent in agents:
            ...
            opinion_delta = self._get_opinion_delta_from_llm(agent, conversation_history)
    ...
    def _get_opinion_delta_from_llm(self, agent: SimpleAgent, conversation_history: List[Tuple]) -> float:
        """
    ...
    def _apply_personality_resistance(self, agent: SimpleAgent, opinion_delta: float) -> float:
        """
